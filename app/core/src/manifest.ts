...
import type { IssueWithContext } from './output-schema.js';
...
export function compareIssues(
  detected: IssueWithContext[],
  expected: ExpectedIssue[]
): {
  matched: Array<{ detected: IssueWithContext; expected: ExpectedIssue }>;
  missed: ExpectedIssue[];
  extra: IssueWithContext[];
} {
  const matched: Array<{ detected: IssueWithContext; expected: ExpectedIssue }> = [];
