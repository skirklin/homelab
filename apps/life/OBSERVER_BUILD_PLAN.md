...
- **C3 — push nudge.** When the assistant posts, fire a push (reuse VAPID infra) so Scott sees it rather than discovering it in-app. **Status: ✓ BUILT 2026-05-30 (worktree `agent-ab53e515`, commit `a6ca8ef`). Reviewed clean, ready to merge.**
