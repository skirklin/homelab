...
export type IssueType = 'timeline_inconsistency' | 'character_inconsistency' | 'fact_contradiction' | 'unresolved_thread' | 'orphaned_payoff' | 'missing_setup' | 'over_foreshadowed' | 'under_foreshadowed' | 'dropped_character' | 'dropped_object' | 'continuity_error';
